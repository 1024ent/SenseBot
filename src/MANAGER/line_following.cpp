...
void line_following_mecanum(void *pvParameters)
{
  for(;;){
    ...
    if ((D1==0 && D2==1 && D3==1 && D4==1 && D5==0) || (D1==0 && D2==1 && D3==1 && D4==0 && D5==0) || (D1==0 && D2==0 && D3==1 && D4==1 && D5==0)|| (D1==0 && D2==0 && D3==1 && D4==0 && D5==0)|| (D1==0 && D2==1 && D3==0 && D4==1 && D5==0) )
    {
      //robot move forward
      mecanum_move_fwd(LOW_SPEED);
    } 
